...
namespace CStudios.Content.Projectiles.Generics
{
    /* This class is a held projectile that animates a gun firing.
	 * 
	 * */
    public abstract class PsybitGun : ModProjectile
	{
		public override string Texture => "CStudios/Content/Projectiles/Generics/PsybitGun";
